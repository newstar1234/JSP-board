						...
						<div style="display:flex; justify-content:space-around;">
							<div style="width:40%;">
								<p style="background:#fd3a3a2e">
									<span style="color:red; front-size:2rem; front-weight:bold">*</span>
									아래 항목은 모두 작성해주세요.
								</p>		
								<div>
									<div class="col-6 col-12-xsmall" style="width:100%">
										<p style="margin:0">
											아이디<span id="idCheck_text" style="front-size:0.7em"></span>
										</p>
								...
								<div class="col-12" style="margin-top:8%">
									<ul class="actions" style="display:flex; justify-contents:center;">
										<li>
